...
public class ItpcSheet implements Iterator {
  ...
  private void writeCellDescr(Row descrRow) {
    ...
    ExcelUtils.writeCell(descrRow, genoMetabStatusIdx, "Extensive (EM/EM); Intermediate (EM/PM, EM/IM, IM/IM, IM/PM); Poor (PM/PM); anything else is categorized as unknown");
